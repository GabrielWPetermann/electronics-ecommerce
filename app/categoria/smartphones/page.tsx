...
const smartphoneProducts = allProducts.filter((product) => product.category === "Smartphones & Tablets")

const subcategories = ["Todos", "iPhone", "Samsung", "iPad", "Xiaomi", "Tablets", "Acessórios"]
...
export default function SmartphonesPage() {
  ...
  const availableBrands = useMemo(() => {
    return Array.from(new Set(smartphoneProducts.map((product) => product.brand)))
  }, [])

  const maxPrice = useMemo(() => {
    return Math.max(...smartphoneProducts.map((product) => product.price))
  }, [])
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <nav className="text-sm text-muted-foreground">
              ...
              <span className="text-foreground">Smartphones & Tablets</span>
            </nav>
            <BackButton />
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="flex-1">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="text-3xl font-bold">Smartphones & Tablets</h1>
