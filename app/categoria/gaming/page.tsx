...
import { gamingProducts, type Product } from "@/lib/products-data"

const subcategories = ["Todos", "Consoles", "Jogos", "Controles", "Cadeiras Gamer", "Acessórios"]
...
export default function GamingPage() {
  ...
  const availableBrands = useMemo(() => {
    return Array.from(new Set(gamingProducts.map((product) => product.brand)))
  }, [])

  const maxPrice = useMemo(() => {
    return Math.max(...gamingProducts.map((product) => product.price))
  }, [])
